...
## Three.js
Alright, so p5.js has been my 2D playground 🎨, but my brain's craving more dimensions! 🤯 I'm itching to escape the flatlands and dive into the wild world of 3D art, where light dances 💡, shadows play, and WebGL unlocks performance that makes my jaw drop! 🤩 Bruno Simon's Three.js Journey is my launchpad 🚀, even though I've already gone full rogue and started building my own weird and wonderful 3D experiments. 🤪 Let's face it, who can resist the allure of building virtual worlds that feel real? 🌐✨
