...
header:
  teaser: /assets/images/wccc/2025-wk19-de-stijl/teaser.png
  image: /assets/images/wccc/2025-wk19-de-stijl/banner.png
tags: ["creative-coding", "p5js", "wccc"]
toc: true
---
...
```
  ...
  ![Isolate one step at a time](/assets/images/wccc/2025-wk19-de-stijl/2025-05-05_WCCChallenge2025Wk19_Step1.png "Using Gemini to TEACH me, rather than blindly following it")

## 2025-05-09 Pivoting to the 2D version for doability 🕒2hr
- Started with just a grid

![Biz](/assets/images/wccc/2025-wk19-de-stijl/2025-05-10_DuStijl_Start.png)

- Looping through and deciding if it's a 1 or 2 step in the x and y and, if so, excluding those points in future

![Biz2](/assets/images/wccc/2025-wk19-de-stijl/2025-05-10_deStijl_Hmmm.png)

- Hmmm a lot of overlap I'm seeing... must be missing excluding some points...

![Biz3](/assets/images/wccc/2025-wk19-de-stijl/2025-05-10_deStijl_Fixed.png)
...
![Biz4](/assets/images/wccc/2025-wk19-de-stijl/2025-05-10_deStijl_BoundProblems.png)
